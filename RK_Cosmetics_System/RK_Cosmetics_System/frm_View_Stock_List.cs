...
namespace RK_Cosmetics_System
{
    public partial class frm_View_Stock_List : Form
    {
        ...
        private void frm_View_Stock_List_Load(object sender, EventArgs e)
        {
            ...
            lbl_View_Stock_List.ForeColor = Color.FromArgb(255, 0, 111);

            pnl_View_Stock_Back.BackColor = Color.FromArgb(42, 42, 54);

            btn_Search.BackColor = Color.FromArgb(255, 0, 111);

            btn_Refresh.BackColor = Color.FromArgb(255, 0, 111);

            dgv_Stock_List.BackgroundColor = Color.FromArgb(82, 82, 92);
        }
    }
}
