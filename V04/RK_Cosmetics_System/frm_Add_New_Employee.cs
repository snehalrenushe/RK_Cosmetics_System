    ...
    public partial class frm_Add_New_Employee : Form
    {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            if (tb_Employee_ID.Text != "" && tb_First_Name.Text != "" && tb_Middle_Name.Text != "" && tb_Last_Name.Text != "" && tb_Mobile_No_1.Text != "" && tb_Aadhar_No.Text != "" && tb_Pan_No.Text != "" && tb_Address.Text != "")
            {
                ...
                Cmd.CommandText = "Insert into Employee_Details (Employee_ID,First_Name,Middle_Name,Last_Name,Date_Of_Birth,Gender,Joining_Date,Mobile_No_1,Mobile_No_2,Aadhar_No,Pan_No,Address) VALUES (@Emp_ID,@F_Name,@M_Name,@L_Name,@Gender,@DOB,@J_Date,@Mob1,@Mob2,@Aadhar_No,@Pan_No,@Add)";
